/* Full-court basketball schematic — white line-art on court blue with
   dimension ticks, echoing the blueprint panel in the design inspiration. */
export function CourtDiagram({ className }: { className?: string }) {
  return (
    <svg
      ...
      className={className}
    >
      <rect width="300" height="560" rx="20" fill="var(--color-court)" />

      <g stroke="#f4f4f1" strokeWidth="1.6" fill="none" opacity="0.92">
        {/* Boundary + half court */}
        <rect x="30" y="30" width="240" height="500" rx="2" />
        <line x1="30" y1="280" x2="270" y2="280" />
        <circle cx="150" cy="280" r="38" />
        <circle cx="150" cy="280" r="4" fill="#f4f4f1" stroke="none" />

        {/* Top half */}
        <rect x="102" y="30" width="96" height="115" />
        <circle cx="150" cy="145" r="36" />
        <line x1="132" y1="54" x2="168" y2="54" strokeWidth="2.4" />
        ...
        <line x1="132" y1="506" x2="168" y2="506" strokeWidth="2.4" />
        <circle cx="150" cy="496" r="7" />
        <path d="M45 530 L45 470 A137 137 0 0 1 255 470 L255 530" />
      </g>

      {/* Dimension ticks */}
      <g stroke="#f4f4f1" strokeWidth="1" opacity="0.55">
