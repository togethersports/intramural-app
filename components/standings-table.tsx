      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="text-left">
            <th className="label sticky-cell sticky left-0 z-10 py-2 pr-3">Team</th>
        ...
        <tbody>
          {rows.map((r, i) => (
            <tr key={r.teamId} className="border-t border-rule">
              <td className="sticky-cell sticky left-0 z-10 py-2.5 pr-3">
                <Link
                ...
                <>
                  ...
                  <td
                    className={`tabular px-2 py-2.5 text-right ${
                      r.diff < 0 ? "text-accent-ink" : "text-ink"
                    }`}
                  >
