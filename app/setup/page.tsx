        ...
        {configured ? (
          ...
          <>
            <p className="text-sm text-ink-soft">
              ...
              <code className="rounded bg-surface-dim px-1.5 py-0.5 text-[13px]">
                supabase/migrations/
              </code>
              , and add these to <code className="rounded bg-surface-dim px-1.5 py-0.5 text-[13px]">.env.local</code>:
            </p>
